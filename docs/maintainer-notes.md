...
- explicit job configuration from CLI/UI
...
Do not over-abstract the runtime model too early. This project is mainly valuable because it remains inspectable and boring.
